...
from system.bvc_model.neuron import phi, phi_inv, phi_vec
from system.bvc_model.parametersHDC import n_hdc, lam_hdc
from system.bvc_model.hdcTargetPeak import targetPeakHD, targetPeakCONJ
from system.bvc_model.helper import angleDistAbs, writeDataToFile
from system.bvc_model.hdcOptimizeAttractor import getHDCActivity
...
def CalcAndPlotWeights():
    ...
    directory = "data/hdc_model/weights"
    ...
    writeDataToFile(wECDtoCONJ, 'data/hdc_model/weights/w_ecd_to_conj.obj')
    writeDataToFile(wECDtoCONJ, 'data/hdc_model/weights/w_acd_to_conj.obj')
    ...
    writeDataToFile(wCONJtoACD, 'data/hdc_model/weights/w_conj_to_acd.obj')
    ...
    writeDataToFile(wCONJtoHD, 'data/hdc_model/weights/w_conj_to_hd.obj')
    ...
    writeDataToFile(wHDtoCONJ, 'data/hdc_model/weights/w_hd_to_conj.obj')
