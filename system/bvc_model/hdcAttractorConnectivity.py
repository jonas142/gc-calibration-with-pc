...
from .parametersHDC import n_hdc

from .neuron import phi, phi_inv, tau
from .helper import angleDistAbs, loadDataFromFile
...
class HDCAttractorConnectivity:
    ...
    def InitCalibrLoopWeights(self):
        try:
            self.w_ecd_to_conj = loadDataFromFile('data/hdc_model/weights/w_ecd_to_conj.obj')
            self.w_acd_to_conj= loadDataFromFile('data/hdc_model/weights/w_acd_to_conj.obj')
            self.w_hd_to_conj= loadDataFromFile('data/hdc_model/weights/w_hd_to_conj.obj')
            self.w_conj_to_acd= loadDataFromFile('data/hdc_model/weights/w_conj_to_acd.obj')
            self.w_conj_to_hd= loadDataFromFile('data/hdc_model/weights/w_conj_to_hd.obj')
        except Exception:
